<nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        <a href="index.php" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary">SohapiGroup</h2>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu fade-up m-0">
                        <a href="notre_missions.php" class="dropdown-item">Ce qu'il faut savoir</a>
                        <a href="nous_contacter.php" class="dropdown-item">Nous contacter</a>
                        <a href="tnotre_team.php" class="dropdown-item">Notre équipe</a>
