            ...
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="d-flex pt-2">
                        <a class="btn btn-outline-light btn-social" href="https://www.facebook.com/profile.php?id=100062976204005"><i class="fab fa-twitter"></i></a>
                        ...
                        <a class="btn btn-outline-light btn-social" href="https://www.facebook.com/profile.php?id=100062976204005"><i class="fab fa-youtube"></i></a>
                        <a class="btn btn-outline-light btn-social" href="https://www.facebook.com/profile.php?id=100062976204005"><i class="fab fa-linkedin-in"></i></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <h4 class="text-light mb-4">Services</h4>
                    <a class="btn btn-link" href="">Notation hopsitalière</a>
                    <a class="btn btn-link" href="">Evernement</a>
                    <a class="btn btn-link" href="">Digital</a>
                    <a class="btn btn-link" href="">Intermediation</a>
                    <a class="btn btn-link" href="">Edition</a>
                </div>
                <div class="col-lg-3 col-md-6">
                    <h4 class="text-light mb-4">Liens Rapides</h4>
                    <a class="btn btn-link" href="apropos_nous.php">À Propos</a>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="index.php">SohapiGroup</a>, Tous Droits Réservés.
                    </div>
                </div>
            </div>
        </div>
